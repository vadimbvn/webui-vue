<template>
  ...
  >
    ...
    <b-form>
      <b-form-group
        :label="$t('pageKvm.modal.serverUri')"
        label-for="serverUri"
      >
        <b-form-input
          id="serverUri"
      ...
      <b-form-group :label="$t('pageKvm.modal.username')" label-for="username">
        <b-form-input
          id="username"
      ...
      <b-form-group :label="$t('pageKvm.modal.password')" label-for="password">
        <b-form-input
          id="password"
